...
/*
#define Bank1_LCD_D ((U32) 0x60040000)
#define Bank1_LCD_C ((U32) 0x60000000)

#define LCD_WR_REG(index) ((* (__IO U16 *) (Bank1_LCD_C)) = ((U16) index))
#define LCD_WR_CMD(index, val) do {(* (__IO U16 *) (Bank1_LCD_C)) = ((I16) index); (* (__IO U16 *) (Bank1_LCD_D)) = ((U16) (val) );} while (0)
...
static void LcdWriteReg(U16 Data) {
  // ... TBD by user
	...
	ILI9341_SendCommand(Data);

/*
	ILI9341_SendCommand(data_L);
	ILI9341_SendCommand(data_H);
*/
...
static void LcdReadDataMultiple(U16 * pData, int NumItems) {
  while (NumItems--) {
    // ... TBD by user
	  //*pData++ = ILI9341_ReadReg((uint8_t*)pData, 1);
	  //while(1);
  }
}
...
int LCD_X_DisplayDriver(unsigned LayerIndex, unsigned Cmd, void * pData) {
  ...
  case LCD_X_INITCONTROLLER: {
	...
	/* This function initializes the following for the lcd
	 * 		- GPIO
	 * 		- SPI
	 * 		- Config
	 */
